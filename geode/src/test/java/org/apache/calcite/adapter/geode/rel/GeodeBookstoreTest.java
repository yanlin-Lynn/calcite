          ...
          @Override public void accept(ResultSet resultSet) {
            try {
              ...
              assertThat(builder.toString(),
                  is("{addressLine1=123 Main St., addressLine2=null, addressLine3=null,"
                      + " addressTag=HOME, city=Topeka, country=US, phoneNumber=423-555-3322,"
                      + " postalCode=50505, state=KS}\n"
                      + "{addressLine1=123 Main St., addressLine2=null, addressLine3=null,"
                      + " addressTag=HOME, city=San Francisco, country=US,"
                      + " phoneNumber=423-555-3322, postalCode=50505, state=CA}\n"));
            } catch (Exception e) {
